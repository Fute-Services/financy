...
const cases: Case[] = [
  // 401
  {
    ...
    error: new E.UnauthenticatedError(),
    code: 'UNAUTHENTICATED',
    status: 401,
  },
  {
    name: 'SessionExpiredError',
    error: new E.SessionExpiredError(),
  ...
  { name: 'ForbiddenError', error: new E.ForbiddenError(), code: 'FORBIDDEN', status: 403 },
  {
    ...
    error: new E.StepUpRequiredError(),
    code: 'STEP_UP_REQUIRED',
    status: 403,
  },
  {
    name: 'SelfApprovalForbiddenError',
    error: new E.SelfApprovalForbiddenError(),
    code: 'SELF_APPROVAL_FORBIDDEN',
    status: 403,
  },
  {
    name: 'SelfElevationForbiddenError',
    error: new E.SelfElevationForbiddenError(),
    code: 'SELF_ELEVATION_FORBIDDEN',
    status: 403,
  },
  {
    name: 'AuditorReadOnlyError',
    error: new E.AuditorReadOnlyError(),
    code: 'AUDITOR_READ_ONLY',
    status: 403,
  },
  {
    name: 'TenantMismatchError',
    error: new E.TenantMismatchError(),
  ...
  {
    name: 'NotFoundError',
    error: new E.NotFoundError('Transaction'),
  ...
  {
    name: 'ConflictError',
    error: new E.ConflictError('conflict'),
    code: 'INVALID_STATE_TRANSITION',
    status: 409,
  },
  {
    name: 'InvalidStateTransitionError',
    error: new E.InvalidStateTransitionError('Spend request', 'DRAFT', 'APPROVED'),
    code: 'INVALID_STATE_TRANSITION',
    status: 409,
  },
  {
    name: 'PostedRecordImmutableError',
    error: new E.PostedRecordImmutableError('Transaction'),
    code: 'POSTED_RECORD_IMMUTABLE',
    status: 409,
  },
  {
    name: 'StaleVersionError',
    error: new E.StaleVersionError('Budget', 3, 5),
    code: 'STALE_VERSION',
    status: 409,
  },
  {
    name: 'IdempotencyKeyReusedError',
    error: new E.IdempotencyKeyReusedError(),
    code: 'IDEMPOTENCY_KEY_REUSED',
    status: 409,
  },
  {
    name: 'RequestInProgressError',
    error: new E.RequestInProgressError(),
    code: 'REQUEST_IN_PROGRESS',
    status: 409,
    retryable: true,
  },
  {
    name: 'StepNotActionableError',
    error: new E.StepNotActionableError(),
    code: 'STEP_NOT_ACTIONABLE',
    status: 409,
  },
  {
    name: 'ExpenseAlreadyReimbursedError',
    error: new E.ExpenseAlreadyReimbursedError('RB-2026-0041'),
    code: 'EXPENSE_ALREADY_REIMBURSED',
    status: 409,
  },
  {
    name: 'BudgetExceededError',
    error: new E.BudgetExceededError(),
    code: 'BUDGET_EXCEEDED',
    status: 409,
  },
  { name: 'LastAdminError', error: new E.LastAdminError(), code: 'LAST_ADMIN', status: 409 },
  {
    name: 'CurrencyLockedError',
    error: new E.CurrencyLockedError(),
    code: 'CURRENCY_LOCKED',
    status: 409,
  },
  {
    name: 'MembershipExistsError',
    error: new E.MembershipExistsError(),
    code: 'MEMBERSHIP_EXISTS',
    status: 409,
  },
  {
    name: 'PolicyBlockedError',
    error: new E.PolicyBlockedError([
  ...
  {
    name: 'CyclicHierarchyError',
    error: new E.CyclicHierarchyError('department'),
  ...
  // 422
  {
    ...
    error: new E.ValidationError({ amount: ['must be greater than 0'] }),
    code: 'VALIDATION_FAILED',
    status: 422,
  },
  {
    name: 'AmountMismatchError',
    error: new E.AmountMismatchError('2400.0000', '2000.0000'),
    code: 'AMOUNT_MISMATCH',
    status: 422,
  },
  {
    name: 'InvalidFileError',
    error: new E.InvalidFileError('That file type is not supported.'),
    code: 'INVALID_FILE',
    status: 422,
  },
  {
    name: 'UnresolvableApproverError',
    error: new E.UnresolvableApproverError(),
    code: 'UNRESOLVABLE_APPROVER',
    status: 422,
  },
  ...
  {
    name: 'PolicyEvaluationFailedError',
    error: new E.PolicyEvaluationFailedError(),
    code: 'POLICY_EVALUATION_FAILED',
    status: 500,
  },
  {
    name: 'TenantContextMissingError',
    error: new E.TenantContextMissingError('Transaction', 'findMany'),
    code: 'TENANT_CONTEXT_MISSING',
    status: 500,
  },
  {
    name: 'ProviderError',
    error: new E.ProviderError('CardProvider', 'issueCard'),
    code: 'PROVIDER_ERROR',
    status: 502,
    retryable: true,
  },
  {
    ...
    error: new E.ProviderTimeoutError('CardProvider', 'issueCard'),
