 ...
 * the endpoints behind them are. Phase 3 now qualifies: expenses,
 * reimbursements, and the finance review queue each read a live endpoint and
 * enforce their permission, alongside everything Phase 2 delivered.
 *
