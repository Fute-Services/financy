...
| FR-RPT-002 | Every figure is computed by a backend query. No aggregate is computed in the browser.                                                                                                    |  M  | An architecture test forbids arithmetic over money in `apps/web`. |
